      ...
      <nav className={styles.customnavbar}>
        <div className={styles.cstnvbitem}>
          <div className={styles.cstimgbtfmb}>
            ...
            {isOpen ? <Image src={'/img/icons/menu/menuclose.png'} alt={'Ícone x para fechar'} className={styles.imgocmnclose} onClick={toggle} height={22}  width={22}/> : <Image src={'/img/icons/menu/menuopen.png'} alt={'Ícone para abrir'} className={styles.imgocmnopen} onClick={toggle} height={22}  width={22}/>}
          </div>
